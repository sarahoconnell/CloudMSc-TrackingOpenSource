...
@Table(name = "scoringset_monthly_labelled", 
       catalog = "repository",
    	    	 uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class ScoringSetLabelled implements java.io.Serializable{
	...
	public void setMonthNumber(Integer weekNumber) {
